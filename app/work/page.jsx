...
const Work = () => {
  ...
  return (
    <motion.section
      ...
      animate={{
        opacity: 1,
        trainsition: { delay: 2.4, duration: 0.4, ease: "easeIn" },
      }}
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transitiion-all"
              />
            </Swiper>
          </div>
        </div>
